...
public class subkriteria extends javax.swing.JPanel {
    ...
    public subkriteria() {
     ...
     public void tabelmodelsubkriteria() {
        ...
        columnModel.getColumn(2).setPreferredWidth(100);  // Lebar kolom Kriteria.
        columnModel.getColumn(3).setPreferredWidth(200); // Lebar kolom Sub Kriteria
    ...
    private void initComponents() {
        ...
        cb_list_kriteria.setBounds(140, 110, 300, 40);
        ...
        add(jTextField2);
        jTextField2.setBounds(140, 170, 300, 40);
        ...
        add(jTextField3);
        jTextField3.setBounds(140, 230, 300, 40);
        ...
        jTabelSubKriteria.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 14)); // NOI18N
        jTabelSubKriteria.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "No.", "Kriteria", "Sub Kriteria", "Bobot"
            }
        ));
        ...
        jTabelSubKriteria.setSelectionBackground(new java.awt.Color(30, 198, 188));
    ...
    private void jTabelSubKriteriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelSubKriteriaMouseClicked
        ...
        String namaKriteriaTabel = jTabelSubKriteria.getValueAt(bar, 2).toString(); // Ambil nama kriteria dari kolom kedua
        System.out.println("Nama Kriteria dari Tabel: " + namaKriteriaTabel);

        // Set value untuk JTextField
        String subNama = jTabelSubKriteria.getValueAt(bar, 3).toString();
        String nilaiRating = jTabelSubKriteria.getValueAt(bar, 4).toString();
