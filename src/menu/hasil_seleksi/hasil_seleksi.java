...
import apotikrifkah.MultilineHeaderRenderer;
...
public class hasil_seleksi extends javax.swing.JPanel {
    ...
    public hasil_seleksi() {
     ...
     public void tabelmodelnormalisasi(){
       ...
       setHeaderTableNormalisasi();
        ...
        columnModel.getColumn(0).setPreferredWidth(180);  // Lebar kolom Obat.
        columnModel.getColumn(1).setPreferredWidth(100); // Lebar kolom Merek
        columnModel.getColumn(2).setPreferredWidth(50); // Lebar kolom Usia  
        columnModel.getColumn(3).setPreferredWidth(50); // Lebar kolom Harga
        columnModel.getColumn(4).setPreferredWidth(50); // Lebar kolom Tipe Obat
        columnModel.getColumn(5).setPreferredWidth(50); // Lebar kolom Efek Samping
     ...
     public void tabelmodelperingkat(){
        try {
            ...
            jTable2.setModel(tbp);
               ResultSet res = conn.ambilData("SELECT nama,merek, nilai FROM tbl_peringkat ORDER BY nilai DESC");
            int rank = 1;
            while (res.next()){
     ...
     private void setHeaderTableNormalisasi() {
       ...
       DefaultTableCellRenderer headerRenderer = new DefaultTableCellRenderer();
        ...
        header.setPreferredSize(new Dimension(header.getWidth(), 25)); // Adjust height as needed
    ...
    public void cariperingkat() {
        try {
            ...
            for (int x = 0; x < jTable1.getRowCount(); x++) {
                ...
                String namaAlternatif = jTable1.getValueAt(x, 0).toString();                
                String merekAlternatif = jTable1.getValueAt(x, 1).toString();


                // Ambil id_alternatif dari database berdasarkan kode
                String idQuery = "SELECT id FROM tbl_alternatif WHERE nama = '" + namaAlternatif + "'";
                ResultSet idResult = conn.ambilData(idQuery);
                int idAlternatif = 0;
                if (idResult.next()) {
                    idAlternatif = idResult.getInt("id");
                } else {
                    throw new IllegalArgumentException("Nama alternatif tidak valid: " + namaAlternatif);
                }

                // Simpan skor ke tabel peringkat
                String insertSql = "INSERT INTO tbl_peringkat (id_alternatif, nama, merek, nilai) VALUES ('" + idAlternatif + "', '" + namaAlternatif + "', '" + merekAlternatif + "', '" + totalScore + "')";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tahap Normalisasi Nilai Data Obat");
        add(jLabel2);
        jLabel2.setBounds(150, 30, 540, 43);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Obat", "Merek", "C1", "C2", "C3", "C4"
            }
        ));
        jTable1.setMinimumSize(new java.awt.Dimension(95, 100));
        jTable1.setRowHeight(25);
        jTable1.setSelectionBackground(new java.awt.Color(30, 198, 188));
        jScrollPane1.setViewportView(jTable1);

        add(jScrollPane1);
        jScrollPane1.setBounds(150, 100, 1005, 156);

        btn_normalisasi.setBackground(new java.awt.Color(26, 172, 183));
        ...
        btn_normalisasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Math.png"))); // NOI18N
        ...
        btn_normalisasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        add(btn_normalisasi);
        btn_normalisasi.setBounds(670, 30, 210, 42);
        ...
        jTable2.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 14)); // NOI18N
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Obat", "Merek", "Nilai", "Peringkat"
            }
        ));
        jTable2.setIntercellSpacing(new java.awt.Dimension(2, 2));
        jTable2.setMinimumSize(new java.awt.Dimension(95, 100));
        jTable2.setRowHeight(25);
        jTable2.setSelectionBackground(new java.awt.Color(30, 198, 188));
        jScrollPane2.setViewportView(jTable2);

        add(jScrollPane2);
        jScrollPane2.setBounds(150, 380, 1010, 156);
